...
// establish a connection to IndexedDB database called 'pizza_hunt' - if database doesn't exist, it is created -  and set it to version 1
...
function saveRecord(record) {
    ...
    // access the onject store for `new_pizza`
